...
public class DragBallPanel extends JPanel implements MouseListener, MouseMotionListener {
    ...
    class ControllerActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            _ballX = _ballX + direction[dir][0];
            _ballY = _ballY + direction[dir][1];
            ...
            if (_ballX >= getWidth() - BALL_DIAMETER) {
                _ballX = getWidth() - BALL_DIAMETER;
                dir = dir == 0 ? 2 : 3;
            }
            ...
            if (_ballY >= getHeight() - BALL_DIAMETER) {
                _ballY = getHeight() - BALL_DIAMETER;
                dir = dir == 0 ? 1 : 3;
            }
